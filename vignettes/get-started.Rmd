...
descriptions, data files, and metadata from the ENCODE Project. ENCODE provides
programmatic access to this information through a REST API. The API returns data
in JSON format.
