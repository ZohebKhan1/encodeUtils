...
test_that("encode_select_files applies presets and keeps exclusion reasons", {
  ...
  testthat::expect_true("raw_reads" %in% encode_file_presets())
  testthat::expect_equal(encode_file_presets("raw_fastq")$file_format, "fastq")
  testthat::expect_error(encode_file_presets("not_a_preset"), "must be one of")
